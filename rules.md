...
- Les débats politiques, géopolitiques, religieux ou idéologiques  
  (ex : conflits internationaux, élections, sujets très polarisants)  
...
- **L’accueil doit être bienveillant ou neutre.**  
  Exemples : « Bienvenue ! », « Hésite pas à te présenter si tu veux. »
- **Il est interdit de :**
  - accuser un nouveau membre d’être un « alt » sans preuve formelle apportée par le staff
  - se moquer de son pseudo, avatar ou façon d’écrire
  - poser des questions agressives ou intimidantes
